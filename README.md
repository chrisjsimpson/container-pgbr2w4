...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pgbr2w4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pgbr2w4.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-pgbr2w4.git
cd container-pgbr2w4
```
...
```
docker attach container-pgbr2w4
```
